frappe.pages['ss-excel-to-ledger-adv-lc'].on_page_load = function(wrapper) {
	var page = frappe.ui.make_app_page({
		parent: wrapper,
		title: 'SS ADV to LC Converter',
		single_column: true
	});
	...
	page.set_primary_action('Convert', () => {
		...
		frappe.call({
			method: 'erpnext.selling.page.ss_excel_to_ledger_adv_lc.ss_excel_to_ledger_adv_lc.convert_excel',
			args: {
