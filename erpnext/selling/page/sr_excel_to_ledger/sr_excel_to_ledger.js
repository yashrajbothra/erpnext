frappe.pages['sr-excel-to-ledger'].on_page_load = function (wrapper) {
	var page = frappe.ui.make_app_page({
		parent: wrapper,
		title: 'SR Excel to Ledger Converter',
		single_column: true
	});
	...
	page.set_primary_action('Convert', () => {
		...
		frappe.call({
			method: 'erpnext.selling.page.sr_excel_to_ledger.sr_excel_to_ledger.convert_excel',
			args: {
